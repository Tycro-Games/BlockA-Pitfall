...
#pragma warning ( disable: 4201 /* nameless struct / union */ )
	...
	//make it printable
	inline ostream& operator<<(ostream& lhs, const float2& pos)
	{
		return lhs << pos.x << " " << pos.y << '\n';
	}
...
//source https://www.gamedev.net/articles/programming/general-and-gameplay-programming/inverse-lerp-a-super-useful-yet-often-overlooked-function-r5230/
inline float invlerp(const float a, const float b, const float t)
{
	return (t - a) / (b - a);
}
...
public:
	...
	CHECK_RESULT mat4 FastInvertedTransformNoScale() const
	{
		...
		auto &inM0 = (__m128&)cell[0], &outM0 = (__m128&)r.cell[0];
		auto &inM1 = (__m128&)cell[4], &outM1 = (__m128&)r.cell[4];
		auto &inM2 = (__m128&)cell[8], &outM2 = (__m128&)r.cell[8];
