...
public:
	...
	void Run(cl_mem* buffers, const int count = 1, cl_event* eventToWaitFor = 0, cl_event* eventToSet = 0,
	         cl_event* acq = 0, cl_event* rel = 0);
	void Run(Buffer* buffer, const int2 localSize = make_int2(32, 2), cl_event* eventToWaitFor = 0,
	         cl_event* eventToSet = 0, cl_event* acq = 0, cl_event* rel = 0);
	void Run(Buffer* buffer, const int count = 1, cl_event* eventToWaitFor = 0, cl_event* eventToSet = 0,
	         cl_event* acq = 0, cl_event* rel = 0);
#endif
...
#define T_ typename
	...
	template <T_ A, T_ B, T_ C>
	void SetArguments(A a, B b, C c)
	{
		InitArgs();
		S(0, a);
		S(1, b);
	...
	template <T_ A, T_ B, T_ C, T_ D>
	void SetArguments(A a, B b, C c, D d)
	{
		InitArgs();
		S(0, a);
		S(1, b);
	...
	template <T_ A, T_ B, T_ C, T_ D, T_ E>
	void SetArguments(A a, B b, C c, D d, E e)
	{
		InitArgs();
		S(0, a);
		S(1, b);
	...
	template <T_ A, T_ B, T_ C, T_ D, T_ E, T_ F>
	void SetArguments(A a, B b, C c, D d, E e, F f)
	{
		InitArgs();
		S(0, a);
		S(1, b);
	...
	template <T_ A, T_ B, T_ C, T_ D, T_ E, T_ F, T_ G>
	void SetArguments(A a, B b, C c, D d, E e, F f, G g)
	{
		InitArgs();
		S(0, a);
		S(1, b);
	...
	template <T_ A, T_ B, T_ C, T_ D, T_ E, T_ F, T_ G, T_ H>
	void SetArguments(A a, B b, C c, D d, E e, F f, G g, H h)
	{
		InitArgs();
		S(0, a);
		S(1, b);
	...
	template <T_ A, T_ B, T_ C, T_ D, T_ E, T_ F, T_ G, T_ H, T_ I>
	void SetArguments(A a, B b, C c, D d, E e, F f, G g, H h, I i)
	{
		InitArgs();
		S(0, a);
		S(1, b);
	...
	template <T_ A, T_ B, T_ C, T_ D, T_ E, T_ F, T_ G, T_ H, T_ I, T_ J, T_ K, T_ L, T_ M, T_ N, T_ O, T_ P, T_ Q, T_
	          R>
